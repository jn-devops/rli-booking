<script setup>
import FloorAreaLogo from './FloorAreaLogo.vue';
...
<template>
    <div class=" grid md:grid-rows-1 lg:grid-cols-2 gap-5">
        <div class="">
        ...
        <div class="">
            <div>
                <div class="border-b-2 pb-4">
                    <div class="flex gap-1">
                        ...
                        <p class="text-sm">₱2,900,000.00</p>
                    </div>
                    <div class="mt-2">
            ...
            <div class="mt-4">
               ...
               <div class="flex gap-1">
                    <p class="font-bold">Toilet and Bath:</p>
                    <p>1</p>
               </div>
            </div>
