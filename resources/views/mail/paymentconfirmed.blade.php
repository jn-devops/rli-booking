...
As part of our procedures, we will process the commission once all required documents are given. In the meantime, we kindly request your assistance in following up on the necessary documents required to tag the reservation as an official sale.
...
Amount: <b>PHP{{number_format($product->processing_fee, 2)}}</b><br>
